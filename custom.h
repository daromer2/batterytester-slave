...
const float shuntResistor = 10.0; // In Ohms - Shunt (Discharge) resistors resistance
const float referenceVoltage = 4.68; // 5V Output of Arduino
...
const byte restTimeMinutes = 1; // The te in Minutes to rest the battery after charge. 0-59 are valid
...
const int offsetMilliOhms = 13; // Offset calibration for MilliOhms
